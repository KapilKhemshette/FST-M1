...
public class Activity1_GoogleChrome {
	AppiumDriver driver;
	WebDriverWait wait;
	...
	public void setup() throws MalformedURLException, URISyntaxException {
		...
		public void toDoTest() throws InterruptedException {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath("//android.widget.EditText[@resource-id=\"taskInput\"]"))).sendKeys("meeting");
			
			driver.findElement(AppiumBy.xpath("//android.widget.Button[@text=\"Add Task\"]")).click();
			Thread.sleep(5000);
			List<WebElement> list2 = driver.findElements(AppiumBy.xpath("//android.view.View[@resource-id=\"tasksList\"]/android.view.View"));
			
			System.out.println(list2.size());
			for(int i=2; i<=list2.size();i++) {
				WebElement element = driver.findElement(AppiumBy.xpath("//android.view.View[@resource-id=\"tasksList\"]/android.view.View["+i+"]/android.view.View"));
