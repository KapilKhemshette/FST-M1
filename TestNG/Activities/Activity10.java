...
public class Activity10 {
    ...
    public static List<List<String>> readExcel(String filePath) {
        ...
        try {
            ...
            for (Row cells : sheet) {
                ...
                for (Cell cell : cells) {
                    // Store row data
                	String strcell=String.valueOf(cell);
    ...
    public void registerTest(List<String> rows) throws InterruptedException {
        ...
        System.out.println(rows.get(2).substring(0, 2));
        System.out.println(rows.get(2).substring(3, 5));
        System.out.println(rows.get(2).substring(6, 10));
